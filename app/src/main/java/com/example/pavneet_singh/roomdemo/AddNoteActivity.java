...
public class AddNoteActivity extends AppCompatActivity {
    ...
    private TextInputEditText et_title, et_content , age;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((note = (Note) getIntent().getSerializableExtra("note")) != null) {
            ...
            age.setText(String.valueOf(note.getAge()));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (update) {
                    ...
                    note.setAge(Integer.parseInt(age.getText().toString()));
                    noteDatabase.getNoteDao().updateNote(note);
                    setResult(note, 2);
                } else {
                    note = new Note(et_content.getText().toString(), et_title.getText().toString(),Integer.parseInt(age.getText().toString()));
